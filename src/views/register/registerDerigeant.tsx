...
const RegisterDerigeant : React.FC =() => {
    const [data,setData]=useState<DerigeantData>({role:"derigeant_club"})
    ...
    const changeHandler = (e: ChangeEvent<HTMLInputElement>) => {
      ...
      const createDerigeant = async (e:FormEvent) => {
        e.preventDefault();
        ...
        try {
          ...
          const response = await auth.creerDerigeant(formData);
          console.log("derigeant créé", response.data);
...
export default RegisterDerigeant

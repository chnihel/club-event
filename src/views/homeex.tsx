...
const Home1 = () => {
    const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false); // Nouvel état pour mobile
    const [isSideMenuOpen, setIsSideMenuOpen] = useState(false); // Changé à true par défaut
          ...
          <ul>
            ...
            <li className="relative px-6 py-3">
              ...
              >
                ...
                <span className="ml-4">Calendrie</span>
              </a>
            </li>
            <li className="relative px-6 py-3">
              <a
